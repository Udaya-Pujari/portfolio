            ...
            <div className="max-w-screen-2xl container mx-auto px-4 md:px-20 my-10">
                ...
                <div>
                    <h1 className="text-2xl font-bold mb-5">
                        <span className="text-sky-500">E</span>xperience
                    </h1>
                </div>
                <div className='flex'>
                    <img src={work} className='hover:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f] w-[50px] h-[50px] border-[2px] border-white rounded-full' alt='work' />
                    <p className='mt-1'>
                        <span className='font-bold cursor-pointer '>Software Developer</span> <br />
                        <span className='text-slate-500'>Techno Touch Business Solutions</span>
                        <span className='text-slate-500 ml-15 ml-20'>Aug 2022 - Present</span>
                    </p>
                </div>
                <div className='flex mt-12 border border-white hover:bg-gradient-to-t from-cyan-300 to-rose-100  hover:shadow-[0_0_2px_#fff,inset_0_0_2px_#fff,0_0_5px_#08f,0_0_15px_#08f,0_0_30px_#08f]'>
                    ...
                    <div className='hidden md:block w-1/4 '>
                        <img className='md:h-full' src={exp} alt='exp' />
                    </div>
                </div>
